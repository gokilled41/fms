...
<body>
	<div class="index_box">
		<div class="attention_menu">
			<div class="m_con">
				<a href="javascript:attention('attention_shop.shtml');" class="active">店铺<span class="num">0</span></a>
				<a href="javascript:attention('attention_reward.shtml');" class="">活动<span class="num">0</span></a>
			</div>
		</div>
	...
	<script type="text/javascript" src="../js/attention_shop.js?t=<%=t%>"></script>

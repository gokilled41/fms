...
<body>
	<div class="index_box">
		<div class="menu_fixed">
			<div class="address_top search_menu">
				<div class="m_con">
					<a href="javascript:search_store();" class="">店铺</a>
					<a href="javascript:search_reward()" class="active">活动</a>
				</div>
			</div>
			<div class="search_box">
				<div class="search_div"><input type="text" class="input_1" id="searchreward" placeholder="请输入活动名称"><a href="javascript:void(0);" class="empty_btn"></a></div>
	...
	<script type="text/javascript" src="../js/search_reward.js?t=<%=t%>"></script>

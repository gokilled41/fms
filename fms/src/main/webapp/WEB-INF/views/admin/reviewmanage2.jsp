            ...
            <div id="content" class="col-lg-10 col-sm-10">
                ...
                <div>
                    <ul class="breadcrumb">
                        ...
                        <li><a href="<%=path%>/page/admin/reviewmanage2.shtml">二级审批</a></li>
                    </ul>
                </div>
                <!-- breadcrumb end -->
            ...
            <div class="modal-dialog" style="width:800px">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <a id="review-approval-reviewdetail-btn" class="btn btn-primary"> 一级审批详情 </a>
                        <a id="review-approval-cancel-btn" class="btn btn-default" data-dismiss="modal"> 取 消 </a>
                    </div>
                </div>
            </div>
        </div>
        <div class="modal fade" id="review-approval-reviewdetail-modal" tabindex="-1"
            role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                    ...
                    <div class="modal-body">
                        <table class="table table-striped">
                            <tbody>
                                <tr>
                                    <td width="50%">审批人</td>
                                    <td width="50%" id="reviewdetail-reviewerNickName"></td>
                                </tr>
                                <tr>
                                    <td>审批意见</td>
                                    <td id="reviewdetail-comments"></td>
                                </tr>
                                <tr>
                                    <td>审批结论</td>
                                    <td id="reviewdetail-conclusion" class="bd"></td>
                                </tr>
                                <tr>
                                    <td>上传附件</td>
                                    <td>
                                        <div id="reviewdetail-attachment-list">
                                        </div>
                                    </td>
                                </tr>
                                <tr class="hd">
                                    <td>审批人ID</td>
                                    <td id="reviewdetail-reviewerId"></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
                    <div class="modal-footer">
                        <label id="review-approval-reviewdetail-note" class="cr hd"></label>
                        <a id="review-approval-reviewdetail-review-btn" class="btn btn-primary"> 审 批 </a>
                        <a id="review-approval-reviewdetail-return-btn" class="btn btn-default"> 返 回 </a>
                        <a id="review-approval-reviewdetail-cancel-btn" class="btn btn-default" data-dismiss="modal"> 取 消 </a>
                    </div>
                </div>
            </div>
        </div>
        <div class="modal fade" id="review-approval-review-modal" tabindex="-1"
            ...
            <div class="modal-dialog" style="width:800px">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form id="review-approval-form" action="<%=path%>/reviewer/reviewer2Submit.shtml" method="post">
                    ...
                    <div class="modal-footer">
                        ...
                        <a id="review-approval-review-submit-btn" class="btn btn-primary"> 提交三级审批人审批 </a>

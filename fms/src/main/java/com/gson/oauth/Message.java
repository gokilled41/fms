...
public class Message {
    ...
    private String sendMsg(String accessToken, Map<String, Object> message) throws Exception {
        ...
        return sendMsg(accessToken, jsonstr);
    }
     ...
     * @throws Exception
     */
    private String sendMsg(String accessToken, String jsonMessage) throws Exception {
        String reslut = HttpKit.post(MESSAGE_URL.concat(accessToken), jsonMessage);
        return reslut;
    }
    ...
    public String SendVideo(String accessToken, String openId, String media_id, String title, String description)
        ...
        Map<String, Object> textObj = new HashMap<String, Object>();
        textObj.put("media_id", media_id);
        textObj.put("thumb_media_id", media_id);
     ...
     * @throws Exception
     */
    public String SendNews(String accessToken, String openId, List<Articles> articlesList) throws Exception {
        Map<String, Object> json = new HashMap<String, Object>();
        ...
        String jsonMessage = JSONObject.toJSONString(json);
        //json区分大小写
        jsonMessage = jsonMessage.replaceAll(",\"picUrl\":", ",\"picurl\":");

        String reslut = sendMsg(accessToken, jsonMessage);
        return reslut;
    }
     ...
     * @throws IOException
     */
    public JSONObject massSendall(String accessToken, String groupId, String mpNewsMediaId)
            throws IOException, ExecutionException, InterruptedException {
        Map<String, Object> json = new HashMap<String, Object>();
     ...
     */
    public JSONObject massSend(String accessToken, String[] openids, String mpNewsMediaId)
